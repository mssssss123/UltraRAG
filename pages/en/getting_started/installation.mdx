...
UR-v2 provides a user-friendly installation process — with just a few commands, users can complete the basic environment setup.  
UR-v2 also supports a modular dependency system that allows flexible installation of required components on demand, avoiding unnecessary dependencies.
...
UR-v2 supports a wide variety of Server components.  
