...
The **Generation Server** is the core module in UR-v2 responsible for **invoking and deploying Large Language Models (LLMs)**.
...
UR-v2 is fully compatible with the **OpenAI API** specification, allowing any model conforming to this standard to be integrated directly—no extra adaptation or code modification required.
