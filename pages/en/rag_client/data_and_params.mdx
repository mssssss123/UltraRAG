...
In UR-v2, the Pipeline achieves **data binding through variable names**. Each Tool declares its input parameters and output variables during registration.  
...
To address this, UR-v2 provides a **parameter renaming mechanism**, allowing developers to flexibly rename variables in the Pipeline without modifying any source code.
...
To resolve variable name conflicts and binding ambiguities, UR-v2 provides a flexible **parameter renaming mechanism**.  
