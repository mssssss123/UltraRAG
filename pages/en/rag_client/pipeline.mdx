...
In UR-v2, a **Pipeline** defines *how an inference task is executed*. It functions like a **task plan**, specifying the exact sequence of operations that the system should perform at each step.
...
In UR-v2, a Pipeline is written in YAML format and defines the full task execution process.  
