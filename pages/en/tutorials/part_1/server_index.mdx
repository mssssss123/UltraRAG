...
In UR-2.0, based on the MCP (Model Context Protocol) architecture, we have unified the functional modules and proposed a more standardized implementation method — Server.
