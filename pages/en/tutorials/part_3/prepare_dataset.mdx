...
We have organized and preprocessed the most commonly used public evaluation datasets in current RAG research and released them on [Huggingface datasets](https://huggingface.co/datasets/UltraRAG/UltraRAG_Benchmark). Users can directly download and use them without any further processing.
